...
import { porLoMenosUnCaracteEspecial,porLoMenosUnNumero,porLoMenosUnaMayuscula } from '../../views/validacion/estado.validacion';
  ...
  initFormRegistro() {
    this.formUsuario = new FormGroup({
      ...
      password: new FormControl(null, [Validators.required,
        ...
        porLoMenosUnCaracteEspecial(),
        porLoMenosUnNumero(),
        porLoMenosUnaMayuscula()
      ]),
      publicaciones:new FormArray([]),
